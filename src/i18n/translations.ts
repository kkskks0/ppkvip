export const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    action: '建议措施',
    nextSteps: '下一步建议',
    disclaimer: '本分析基于排出物特征的健康评估，仅供参考，不构成医疗诊断。保持健康饮食和良好的生活习惯是肝胆健康的基础。',
    ...
    features: '核心功能',
    feat1: '颜色→病症映射',
    feat1Desc: '11种颜色对应不同健康状态和严重程度',
    feat2: '形态→疾病关联',
    feat2Desc: '11种形态识别胆管状态与结晶类型',
    feat3: '性别差异化分析',
    ...
    brandPromoFeature1: 'AI智能识别 · 11种颜色诊断',
    brandPromoFeature2: '质地成分分析 · 疾病风险评估',
    ...
    medicalHistory: '既往病史',
    medicalHistoryPlaceholder: '如：胆囊炎、脂肪肝、糖尿病等',
  ...
  zhTW: {
    ...
    action: '建議措施',
    nextSteps: '下一步建議',
    disclaimer: '本分析基於排出物特徵的健康評估，僅供參考，不構成醫療診斷。保持健康飲食和良好的生活習慣是肝膽健康的基礎。',
    ...
    features: '核心功能',
    feat1: '顏色→病症對應',
    feat1Desc: '11種顏色對應不同健康狀態與嚴重程度',
    feat2: '形態→疾病關聯',
    feat2Desc: '11種形態辨識膽管狀態與結晶類型',
    feat3: '性別差異化分析',
    ...
    brandPromoFeature1: 'AI智慧辨識 · 11種顏色診斷',
    brandPromoFeature2: '質地成分分析 · 疾病風險評估',
    ...
    medicalHistory: '既往病史',
    medicalHistoryPlaceholder: '如：膽囊炎、脂肪肝、糖尿病等',
  ...
  en: {
    ...
    shapeSignificance: 'Clinical Significance',
    ...
    quantitySignificance: 'Clinical Significance',
    ...
    disclaimer: 'This health assessment is based on discharge characteristics and is for informational purposes only. Maintaining a healthy diet and lifestyle is the foundation of liver and gallbladder wellness.',
    ...
    feat2: 'Morphology → Disease Correlation',
    feat2Desc: '11 shapes for bile duct status and crystal type identification',
    ...
    brandPromoFeature1: 'AI Recognition · 11-color diagnosis',
    brandPromoFeature2: 'Texture & composition · Risk assessment',
    ...
    medicalHistoryPlaceholder: 'e.g., Cholecystitis, fatty liver, diabetes',
